To create a Dockerfile for building an Nginx image, you can follow the example below. This Dockerfile assumes that you want a simple configuration with a custom HTML file served by Nginx.  
